...
class IngameStorage {
  public:
    ...
    size_t get_item(size_t index, ItemTable& result);
  ...
  protected:
    ...
    size_t get_item_bonuses(size_t query_id, size_t*& bonuses);
    size_t get_item_penalties(size_t query_id, size_t*& penalties);
    size_t get_item_slots(size_t query_id, bool*& slots);
    size_t get_item_cost(size_t query_id, size_t*& cost);
